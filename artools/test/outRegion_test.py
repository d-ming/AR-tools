...
def test_in_1():
    ...
    assert outRegion(xi, A, b) is False
...
def test_tol_in_1():
    ...
    assert outRegion(xi, A, b, tol=tol) is False
...
def test_tol_out_1():
    ...
    assert outRegion(xi, A, b, tol=tol)
